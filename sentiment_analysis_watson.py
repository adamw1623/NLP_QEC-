...
def PersonalityScores(column):
	...
	return openness_raw, conscientiousness_raw, extraversion_raw, agreeableness_raw, neuroticism_raw, openness_perc, conscientiousness_perc, extraversion_perc, agreeableness_perc, neuroticism_perc
